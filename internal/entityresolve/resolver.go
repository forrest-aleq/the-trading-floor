...
var aliasIndex = buildAliasIndex([]definition{
	...
	{ID: "company:MU", Name: "Micron Technology", Type: "company", Aliases: []string{"MU", "MICRON", "MICRON TECHNOLOGY"}},
	{ID: "company:RACE", Name: "Ferrari", Type: "company", Aliases: []string{"RACE", "FERRARI", "FERRARI NV", "FERRARI N.V.", "PRANCING HORSE"}},
	{ID: "company:AMD", Name: "Advanced Micro Devices", Type: "company", Aliases: []string{"AMD", "ADVANCED MICRO DEVICES"}},
	{ID: "company:TSM", Name: "Taiwan Semiconductor", Type: "company", Aliases: []string{"TSM", "TSMC", "TAIWAN SEMICONDUCTOR"}},
	{ID: "etf:EWY", Name: "iShares MSCI South Korea ETF", Type: "etf", Aliases: []string{"EWY", "SOUTH KOREA", "KOSPI", "KOREAN STOCKS"}},
