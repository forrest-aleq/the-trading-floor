...
func schemaStatements() []string {
	return []string{
		...
		"CREATE CONSTRAINT portfolio_snapshot_id IF NOT EXISTS FOR (n:PortfolioSnapshot) REQUIRE n.id IS UNIQUE",
		"CREATE CONSTRAINT portfolio_factor_exposure_id IF NOT EXISTS FOR (n:PortfolioFactorExposure) REQUIRE n.id IS UNIQUE",
		"CREATE CONSTRAINT desk_factor_contribution_id IF NOT EXISTS FOR (n:DeskFactorContribution) REQUIRE n.id IS UNIQUE",
		...
		"CREATE CONSTRAINT source_lead_time_belief_key IF NOT EXISTS FOR (n:SourceLeadTimeBelief) REQUIRE n.key IS UNIQUE",
