...
type Signal struct {
	...
	Expectation            *model.ExpectationState     `json:"expectation,omitempty"`
	Appraisal              *model.AppraisalState       `json:"appraisal,omitempty"`
	ActionSelection        *model.ActionSelectionState `json:"action_selection,omitempty"`
